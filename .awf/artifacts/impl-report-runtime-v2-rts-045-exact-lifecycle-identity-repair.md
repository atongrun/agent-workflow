...
Independent L3 Gate Review must verify that the repair denies before native calls, does not broaden
legacy compatibility, preserves install/reinstall/upgrade behavior and closes both RTS-044 findings.
