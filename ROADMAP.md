...
- [ ] Integrate PR #96 after its externally rate-limited macOS arm64 native job is green; three
  bounded retries failed at the same GitHub API 403 while all ordinary CI and four native cells passed.
...
Current last passed TaskCard gate is RTS-001; repository integration remains `EXTERNAL_BLOCKED`.
