...
`verify.py` is the experiment-only build/evidence driver. It intentionally lives outside
production `scripts/`, whose subprocess ownership is locked to the unified runtime executor.
